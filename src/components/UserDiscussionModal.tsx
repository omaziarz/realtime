...
import { AdminDiscussionChatMessage, UserMessage } from "@prisma/client";
import { useMutation, useQuery } from "@tanstack/react-query";
import { useSession } from "next-auth/react";

async function getMessages(id: string) {
  const res = await fetch("/api/customer/messages/" + id);
...
export default function UserDiscussionModal({
  chatId,
  name,
}: {
  chatId: string;
  ...
  const isSender = (message: UserChatMessage) => {
